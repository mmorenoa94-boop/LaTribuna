        ...
        <>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="overflow-y-auto flex-1 px-5 pb-6 flex flex-col gap-4">
              {!isEdit && (
                <div>
                  <label className="block font-condensed text-xs text-lt-muted2 uppercase tracking-wide mb-2">Tipo de pregunta</label>
              ...
              <div>
                <label className="block font-condensed text-xs text-lt-muted2 uppercase tracking-wide mb-1.5">Pregunta *</label>
                <textarea
                  value={text}
              ...
              {isScore ? (
                ...
                <div>
                  <label className="block font-condensed text-xs text-lt-muted2 uppercase tracking-wide mb-2">Opciones de respuesta</label>
              ...
              <div>
                <label className="block font-condensed text-xs text-lt-muted2 uppercase tracking-wide mb-2">Puntos por acertar</label>
              ...
              <div>
                <label className="block font-condensed text-xs text-lt-muted2 uppercase tracking-wide mb-2">¿Cuándo se responde?</label>
