                ...
                <div className="flex-1 overflow-y-auto px-5 pb-6">
                  {loadingSearch ? (
                    ...
                    <div className="text-center py-8">
                      ...
                      <p className="font-condensed text-sm text-lt-muted2">No hay partidos para este día</p>
                      <p className="font-condensed text-xs text-lt-muted mt-1">Prueba otra fecha o usa el modo Manual</p>
                    </div>
                  ) : (
                    <div className="flex flex-col gap-2">
                      {Object.entries(
                        ...
                        <div key={comp}>
                          <p className="font-condensed text-xs text-lt-muted2 uppercase tracking-wide py-2">{comp}</p>
                          <div className="flex flex-col gap-2">
                            {matches.map((f) => {
                              ...
                              return (
                                <div
                                  ...
                                  className={cn(
                                    ...
                                    f.alreadyImported ? 'border-lt-green/30 opacity-60' : 'border-[rgba(255,255,255,0.07)]'
                                  )}
                                >
                                  <div className="flex-1 min-w-0">
                                    <div className="flex items-center gap-2">
                                      {f.homeLogo && <Image src={f.homeLogo} alt="" width={20} height={20} className="object-contain flex-shrink-0" />}
                                      ...
                                      {f.awayLogo && <Image src={f.awayLogo} alt="" width={20} height={20} className="object-contain flex-shrink-0" />}
                                    </div>
